...
@ cdecl wined3d_swapchain_get_present_capabilities(ptr long ptr ptr ptr)
@ cdecl wined3d_swapchain_get_present_result(ptr int64 ptr)
@ cdecl wined3d_swapchain_wait_present_result(ptr int64 ptr)
...
@ cdecl wined3d_swapchain_invalidate_present_results(ptr)
@ cdecl wined3d_swapchain_present(ptr ptr ptr ptr long long)
@ cdecl wined3d_swapchain_present_with_token(ptr ptr ptr ptr long long ptr)
...
@ cdecl wined3d_texture_disable_shared_handle(ptr)
...
@ cdecl wined3d_texture_get_shared_handle(ptr ptr)
@ cdecl wined3d_texture_sync_shared(ptr long int64 long)
@ cdecl wined3d_texture_reopen_shared(ptr ptr)
@ cdecl wined3d_texture_create_shared_sync(ptr ptr)
...
@ cdecl wined3d_texture_set_shared_handle(ptr ptr)
