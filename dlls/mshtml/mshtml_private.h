...
#define PRIVATE_TID_LIST \
    ...
    XIID(IWineHTMLObjectPrivate) \
    XIID(IWineHTMLSelectPrivate) \
    XIID(IWineHTMLTextAreaPrivate) \
...
HRESULT create_child_collection(nsIDOMNodeList*,DispatchEx*,BOOL,IHTMLDOMChildrenCollection**);
