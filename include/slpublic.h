...
SLCAPI HRESULT WINAPI SLGetInstalledProductKeyIds(HSLC, const SLID*, UINT*, SLID**);
...
SLCAPI HRESULT WINAPI SLInstallProofOfPurchase(HSLC, LPCWSTR, LPCWSTR, UINT, BYTE*, SLID*);
SLCAPI HRESULT WINAPI SLSetCurrentProductKey(HSLC, const SLID*, const SLID*);
SLCAPI HRESULT WINAPI SLUninstallProofOfPurchase(HSLC, const SLID*);
