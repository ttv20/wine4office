...
NTSYSAPI NTSTATUS  WINAPI NtQueryMultipleValueKey(HANDLE,PKEY_MULTIPLE_VALUE_INFORMATION,ULONG,PVOID,PULONG,PULONG);
...
NTSYSAPI NTSTATUS  WINAPI RtlCopySid(DWORD,PSID,PSID);
