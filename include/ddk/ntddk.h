...
PVOID     WINAPI RtlInsertElementGenericTableAvl(PRTL_AVL_TABLE,void *,ULONG,PBOOLEAN);
BOOLEAN   WINAPI RtlIsGenericTableEmpty(PRTL_GENERIC_TABLE);
BOOLEAN   WINAPI RtlIsGenericTableEmptyAvl(PRTL_AVL_TABLE);
BOOLEAN   WINAPI RtlIsNameInExpression(UNICODE_STRING*,UNICODE_STRING*,BOOLEAN,PWCH);
