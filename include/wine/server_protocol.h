...
#define WINE_WAYLAND_WINDOW_ACTION_REQUEST  1
#define WINE_WAYLAND_WINDOW_ACTION_QUERY    2
#define WINE_WAYLAND_WINDOW_ACTION_CLAIM    3
#define WINE_WAYLAND_WINDOW_ACTION_RESULT   4
#define WINE_WAYLAND_WINDOW_ACTION_MOVE     1
#define WINE_WAYLAND_WINDOW_ACTION_RESIZE   2
#define WINE_WAYLAND_WINDOW_ACTION_PENDING  1
#define WINE_WAYLAND_WINDOW_ACTION_CLAIMED  2
#define WINE_WAYLAND_WINDOW_ACTION_ISSUED   3
#define WINE_WAYLAND_WINDOW_ACTION_REJECTED 4
...
/* Admit an owner-thread move/resize against a held native button. A host
 * claims it before issuing the connection-local request. ISSUED is not a
 * compositor acceptance or completion notification. Edges use WMSZ_* values. */
struct manage_wayland_window_action_request
{
    struct request_header __header;
    user_handle_t    root;
    unsigned int     operation;
...
struct manage_wayland_window_action_reply
{
    struct reply_header __header;
    unsigned __int64 host_epoch;
    unsigned __int64 request_id;
...
enum request
{
    ...
    REQ_manage_wayland_window_action,
    REQ_NB_REQUESTS
};
...
union generic_request
{
    ...
    struct manage_wayland_window_action_request manage_wayland_window_action_request;
};
union generic_reply
{
    struct request_max_size max_size;
    ...
    struct manage_wayland_window_action_reply manage_wayland_window_action_reply;
};
