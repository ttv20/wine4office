...
enum wine_internal_message
{
    ...
    WM_WINE_REDRAWWINDOW,
    WM_WINE_FIRST_DRIVER_MSG = 0x80001000,  /* range of messages reserved for the USER driver */
    WM_WINE_WAYLAND_HOST_CONFIGURE = 0x80001100,
    WM_WINE_WAYLAND_NATIVE_LEASE = 0x80001101,
    WM_WINE_WAYLAND_HOST_KEYBOARD_GROUP = 0x80001102,
    WM_WINE_WAYLAND_HOST_FOCUS = 0x80001103,
