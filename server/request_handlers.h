...
static const req_handler req_handlers[REQ_NB_REQUESTS] =
{
    ...
    (req_handler)req_create_wayland_buffer_pool,
    (req_handler)req_retire_wayland_buffer_pool,
...
C_ASSERT( offsetof(struct set_win_timer_request, tolerance) == 24 );
C_ASSERT( offsetof(struct set_win_timer_request, id) == 32 );
C_ASSERT( offsetof(struct set_win_timer_request, lparam) == 40 );
C_ASSERT( sizeof(struct set_win_timer_request) == 48 );
...
C_ASSERT( offsetof(struct create_window_request, dpi) == 60 );
C_ASSERT( offsetof(struct create_window_request, raw_dpi) == 64 );
C_ASSERT( sizeof(struct create_window_request) == 72 );
...
C_ASSERT( offsetof(struct get_wayland_host_reply, device_uuid_0) == 48 );
C_ASSERT( offsetof(struct get_wayland_host_reply, device_uuid_1) == 52 );
C_ASSERT( offsetof(struct get_wayland_host_reply, device_uuid_2) == 56 );
C_ASSERT( offsetof(struct get_wayland_host_reply, device_uuid_3) == 60 );
C_ASSERT( sizeof(struct get_wayland_host_reply) == 64 );
...
C_ASSERT( offsetof(struct publish_wayland_scene_reply, owner_revision) == 16 );
C_ASSERT( sizeof(struct publish_wayland_scene_reply) == 24 );
...
C_ASSERT( offsetof(struct create_wayland_buffer_pool_request, root) == 12 );
C_ASSERT( offsetof(struct create_wayland_buffer_pool_request, contributor_id) == 16 );
C_ASSERT( offsetof(struct create_wayland_buffer_pool_request, stream_id) == 24 );
C_ASSERT( offsetof(struct create_wayland_buffer_pool_request, binding_generation) == 32 );
...
C_ASSERT( offsetof(struct retire_wayland_buffer_pool_request, binding_generation) == 32 );
C_ASSERT( offsetof(struct retire_wayland_buffer_pool_request, pool_generation) == 40 );
C_ASSERT( sizeof(struct retire_wayland_buffer_pool_request) == 48 );
C_ASSERT( offsetof(struct retire_wayland_buffer_pool_reply, registry_generation) == 8 );
C_ASSERT( sizeof(struct retire_wayland_buffer_pool_reply) == 16 );
C_ASSERT( offsetof(struct get_wayland_buffer_pool_request, root) == 12 );
C_ASSERT( offsetof(struct get_wayland_buffer_pool_request, host_epoch) == 16 );
C_ASSERT( offsetof(struct get_wayland_buffer_pool_request, contributor_id) == 24 );
C_ASSERT( offsetof(struct get_wayland_buffer_pool_request, previous_pool_generation) == 32 );
C_ASSERT( sizeof(struct get_wayland_buffer_pool_request) == 40 );
C_ASSERT( offsetof(struct get_wayland_buffer_pool_reply, pool_generation) == 8 );
C_ASSERT( offsetof(struct get_wayland_buffer_pool_reply, allocation_size) == 16 );
C_ASSERT( offsetof(struct get_wayland_buffer_pool_reply, registry_generation) == 24 );
C_ASSERT( offsetof(struct get_wayland_buffer_pool_reply, width) == 32 );
C_ASSERT( offsetof(struct get_wayland_buffer_pool_reply, height) == 36 );
...
C_ASSERT( offsetof(struct get_wayland_buffer_pool_reply, device_uuid_3) == 68 );
C_ASSERT( sizeof(struct get_wayland_buffer_pool_reply) == 72 );
C_ASSERT( offsetof(struct register_wayland_buffer_slot_request, root) == 12 );
C_ASSERT( offsetof(struct register_wayland_buffer_slot_request, slot) == 16 );
C_ASSERT( offsetof(struct register_wayland_buffer_slot_request, contributor_id) == 24 );
C_ASSERT( offsetof(struct register_wayland_buffer_slot_request, stream_id) == 32 );
C_ASSERT( offsetof(struct register_wayland_buffer_slot_request, binding_generation) == 40 );
C_ASSERT( offsetof(struct register_wayland_buffer_slot_request, pool_generation) == 48 );
C_ASSERT( offsetof(struct register_wayland_buffer_slot_request, memory) == 56 );
C_ASSERT( offsetof(struct register_wayland_buffer_slot_request, ready_sync) == 60 );
C_ASSERT( offsetof(struct register_wayland_buffer_slot_request, reuse_sync) == 64 );
C_ASSERT( sizeof(struct register_wayland_buffer_slot_request) == 72 );
C_ASSERT( offsetof(struct register_wayland_buffer_slot_reply, registry_generation) == 8 );
C_ASSERT( offsetof(struct register_wayland_buffer_slot_reply, registered_slots) == 16 );
C_ASSERT( sizeof(struct register_wayland_buffer_slot_reply) == 24 );
C_ASSERT( offsetof(struct get_wayland_buffer_slot_request, root) == 12 );
C_ASSERT( offsetof(struct get_wayland_buffer_slot_request, slot) == 16 );
C_ASSERT( offsetof(struct get_wayland_buffer_slot_request, host_epoch) == 24 );
C_ASSERT( offsetof(struct get_wayland_buffer_slot_request, contributor_id) == 32 );
C_ASSERT( offsetof(struct get_wayland_buffer_slot_request, pool_generation) == 40 );
C_ASSERT( sizeof(struct get_wayland_buffer_slot_request) == 48 );
C_ASSERT( offsetof(struct get_wayland_buffer_slot_reply, memory) == 8 );
...
C_ASSERT( offsetof(struct get_wayland_host_root_request, previous_root) == 12 );
C_ASSERT( offsetof(struct get_wayland_host_root_request, host_epoch) == 16 );
C_ASSERT( sizeof(struct get_wayland_host_root_request) == 24 );
C_ASSERT( offsetof(struct get_wayland_host_root_reply, root) == 8 );
C_ASSERT( offsetof(struct get_wayland_host_root_reply, root_identity) == 16 );
C_ASSERT( offsetof(struct get_wayland_host_root_reply, root_generation) == 24 );
C_ASSERT( offsetof(struct get_wayland_host_root_reply, scene_generation) == 32 );
C_ASSERT( offsetof(struct get_wayland_host_root_reply, registry_generation) == 40 );
C_ASSERT( sizeof(struct get_wayland_host_root_reply) == 48 );
C_ASSERT( offsetof(struct get_wayland_window_state_request, root) == 12 );
...
C_ASSERT( offsetof(struct reset_wayland_host_input_request, root) == 12 );
C_ASSERT( offsetof(struct reset_wayland_host_input_request, flags) == 16 );
C_ASSERT( offsetof(struct reset_wayland_host_input_request, host_epoch) == 24 );
C_ASSERT( offsetof(struct reset_wayland_host_input_request, root_identity) == 32 );
