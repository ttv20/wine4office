...
ROWS = (
    ...
    ("Install Office & Teams", "Инсталиране на Office и Teams", "Instaliraj Office i Teams", "Instaliraj Office i Teams", "Namesti Office in Teams", "Įdiegti Office ir Teams", "Instalēt Office un Teams", "Paigalda Office ja Teams", "Setja upp Office & Teams", "Pasang Office & Teams", "I-install ang Office at Teams", "Office ও Teams ইনস্টল করুন", "Office மற்றும் Teams-ஐ நிறுவு", "Office మరియు Teamsను ఇన్‌స్టాల్ చేయండి", "Office आणि Teams स्थापित करा", "Office اور Teams انسٹال کریں"),
