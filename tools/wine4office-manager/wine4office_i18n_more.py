...
ROWS = (
    ...
    ("Install Office", "Installera Office", "Installer Office", "Installer Office", "Asenna Office", "Nainstalovat Office", "Nainštalovať Office", "Office telepítése", "Instalează Office", "Εγκατάσταση Office", "Instal Office", "Cài đặt Office", "نصب Office", "Office इंस्टॉल करें", "ติดตั้ง Office", "Instal·la l'Office"),
